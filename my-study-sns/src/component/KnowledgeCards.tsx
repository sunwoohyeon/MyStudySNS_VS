...
export default function KnowledgeCards() {
  ...
  return (
    <div className="p-5 bg-gray-100 rounded-xl dark:bg-gray-800">
      ...
      <div className="flex space-x-4 overflow-x-auto pb-4 scrollbar-hide">
        {cards.map((card) => (
          <Link
            ...
            className="block flex-shrink-0 w-80 bg-white dark:bg-gray-700 rounded-lg shadow hover:shadow-lg transition-shadow overflow-hidden flex flex-col"
          >
