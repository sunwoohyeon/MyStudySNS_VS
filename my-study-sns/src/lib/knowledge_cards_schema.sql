...
-- Create policy to allow delete for authenticated users (optional, for cleanup)
CREATE POLICY "Enable delete for authenticated users" ON public.knowledge_cards
